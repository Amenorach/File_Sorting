                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-5 mb-3 clearfix">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 style="font-size: 24px;">Tour Requests</h3>
                                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $result = get_all_trecords_ctr();

                                        foreach ($result as $contact) {
                                            echo "<tr>
                                                    <td>" . $contact['tour_id'] . "</td>
                                                    <td>" . $contact['rep_fname'] . "</td>
                                                    <td>" . $contact['rep_lname'] . "</td>
                                                    <td>" . $contact['org_name'] . "</td>
                                                    <td>" . $contact['age_range'] . "</td>
                                                    <td>" . $contact['population'] . "</td>
                                                    <td>" . $contact['tour_purpose'] . "</td>
                                                    <td>" . $contact['arrival_date'] . "</td>
                                                    <td>" . $contact['arrival_time'] . "</td>
                                                    <td>" . $contact['expectations'] . "</td>
                                                    <td>";
                                                "</tr>";
                                        }
                                        ?>
