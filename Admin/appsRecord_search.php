                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-5 mb-3 clearfix">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 style="font-size: 24px;">Workshop Applicants</h3>
                                        </div>
                                    ...
                                    <div class="row style=size:10px;">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $searchResults = search_for_Arecord_ctr($searchkeys);

                                                foreach ($searchResults as $result) {
                                                    $id = $result['app_id'];
                                                    $fname = $result['app_fname'];
                                                    $lname = $result['app_lname'];
                                                    $app_email = $result['app_email'];
                                                    $app_DOB = $result['app_DOB'];
                                                    $gender = $result['gender'];
                                                    $app_residence = $result['app_residence'];
                                                    $country = $result['country'];
                                                    $city = $result['city'];
                                                    $app_CV = $result['app_CV'];
                                                    $app_sOfPurpose = $result['app_sOfPurpose'];
                                                    $app_Pfolio = $result['app_Pfolio'];
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $app_DOB; ?></td>
                                                        <td><?php echo $gender; ?></td>
                                                        <td><?php echo $app_residence; ?></td>
                                                        <td><?php echo $country; ?></td>
                                                        <td><?php echo $city; ?></td>
                                                        <td><?php echo $app_CV; ?></td>
                                                        <td><?php echo $app_sOfPurpose; ?></td>
                                                        <td><?php echo $app_Pfolio; ?></td>
                                                        <td>
                                                            <?php
                                                            // if (!empty($result['Pfolio'])) {
                                                            //     $portfolioLink = $result['Pfolio'];
                                                            //     echo "<a href=\"$portfolioLink\" target=\"_blank\">View Portfolio</a>";
                                                            // } else {
