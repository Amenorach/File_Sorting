                                ...
                                <div class="mt-5 mb-3 clearfix">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-md-right">
                                            <form action="workshopRecord_search.php" method="GET" role="search">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $contact) {
                                            echo "<tr>
                                                    <td>" . $contact['workshop_id'] . "</td>
                                                    <td>" . $contact['fname'] . "</td>
                                                    <td>" . $contact['lname'] . "</td>
                                                    <td>" . $contact['age'] . "</td>
                                                    <td>" . $contact['wk_email'] . "</td>
                                                    <td>" . $contact['gender'] . "</td>
                                                    <td>" . $contact['occupation'] . "</td>
                                                    <td>" . $contact['contact'] . "</td>
                                                    <td>" . $contact['areaofInterest'] . "</td>
                                                    <td>";

                                                    // if (!empty($contact['Pfolio'])) {
                                                    //     $portfolioLink = $contact['Pfolio'];
                                                    //     echo "<a href=\"$portfolioLink\" target=\"_blank\">View Portfolio</a>";
                                                    // } else {
                                                    //     echo "No portfolio link available";
                                                    // }

                                                    // Check if a portfolio file is available
                                                    if (!empty($contact['Pfolio'])) {
                                                        $fileUrl = '../workshop_uploads/' . $contact['Pfolio'];
                                                        echo "<a href=\"$fileUrl\" download>" . $contact['Pfolio'] . "</a>";
